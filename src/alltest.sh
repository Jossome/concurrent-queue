...
./timing.sh ./sssp_blocking ../inputs/graphs/rmat22.txt ../inputs/reference-outputs/rmat22-0.txt > rmat22_blocking.res
python get.py rmat22_blocking.res
./timing.sh ./sssp_lockfree ../inputs/graphs/rmat22.txt ../inputs/reference-outputs/rmat22-0.txt > rmat22_lockfree.res
